...
1. Modules - blocks of functionalities that belong together.  
   ...
   ```
2. Components - defines the behavior of a portion of a screen. Inside a component we have:
   ...
   ```  
3. Services - define reusable functionalities that are independent of the views. This means that we can use a single service in different components. Dependency injection is a way to supply dependencies and to supply services to different classes or components, we use dependency injection, and to use a service in Angular, we need to inject it in the components constructor.
